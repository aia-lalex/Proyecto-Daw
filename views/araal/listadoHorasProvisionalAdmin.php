...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="text-center">Lista de horas trabajadas sin firmar</h1>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?php echo $dato['nombreObra'] ?> </td>
                                <td> <?php echo $dato['concepto'] ?> </td>
                                <td class="botones">
                                    <a class="btn-danger" href="index.php?controller=araal&action=deleteHoras&idHoras=<?php echo $dato['idHoras'] ?>" onclick="return confirm('¿Desesas borrar el registro?');"><i class="fa-solid fa-x"></i></a>
                                    <a class="btn-secondary" href="index.php?controller=araal&action=firmaHoras&idHoras=<?php echo $dato['idHoras'] ?>&horas=<?php echo $dato['horas'] ?>&dia=<?php echo $dato['dia'] ?>&nombre=<?php echo $dato['id'] ?>&concepto=<?php echo $dato['concepto'] ?>&nombreObra=<?php echo  $dato['obra'] ?>" onclick="return confirm('¿Desesas aceptar el registro?');"><i class="fa-solid fa-check"></i></a>
                                </td>
                            </tr>
                        <?php  }
                        ?>
                ...
                if (!isset($dato) or $dato == null) {
                    echo '<h4>No existe ningun parte para firmar</h4>';
                }
                ?>
