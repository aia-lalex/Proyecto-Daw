...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="text-center">Listado de materiales usados</h1>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="botones">
                                    <a class="btn-danger" href="index.php?controller=araal&action=deleteMaterial&idTablaMater=<?php echo $dato['idTablaMater'] ?>&idProducto=<?php echo $dato['material'] ?>&coste=<?php echo $dato['costeMaterial'] ?>&idObra=<?php echo $dato['idObra'] ?>&numero=<?php echo $dato['numero'] ?>&id=<?php echo $dato['id'] ?>" onclick="return confirm('¿Desesas borrar el registro?');"><i class="fa-solid fa-x"></i></a>
                                </td>
                            </tr>
                        <?php  }
                        ?>
                ...
                if (!isset($dato) or $dato == null) {
                    echo '<h4>No existe ningun material usado</h4>';
                }
                ?>
    ...
    <footer class="container-fluid py-5 mt-5">
        <div class="row">
            <div class="col-12 d-flex flex-column justify-content-center col-md-4">
                <div class="d-flex justify-content-center"><img src="web/img/ARAALOGOL.png" ALT=Logo></div>
            </div>
