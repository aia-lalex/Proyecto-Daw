    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                ...
                <p class="text-center">Mapa de situación</p>
            </div>
        </div>
        <div class="row mt-5">
            <div id="mapa"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3192.6800213401616!2d-2.467317084853892!3d36.85013867993838!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd7075f9253c8cfd%3A0x10423ef17d0655c!2sI.E.S.%20Al-%C3%81ndalus!5e0!3m2!1ses!2ses!4v1644699948599!5m2!1ses!2ses" style="border:0;" allowfullscreen="" loading="lazy"></iframe></div>
        </div>
        <div class="row">
            <div class="col">
                <h2 class="text-center">Nuestra localización</h2>
                <p class="text-center">Calle me lo invento nº 11 Cuenca (Almería)</p>
            </div>
        </div>
    </div>
    <footer class="container-fluid py-5 mt-5">
        <div class="row">
            ...
            <div class="col-12 col-md-4 mt-4 mt-md-0">
                <div class="d-flex flex-column align-items-center"><a href="index.php?controller=araal&action=listado">Inicio</a><a href="index.php?controller=araal&action=listadoAdmin">
                        <div <?php echo isset($_SESSION['usu']) && $_SESSION["rol"] == 1 ? "style='display:block'" : "style='display:none'" ?>>Administrador
                    </a></div>
                <div id=2 <?php echo isset($_SESSION['usu']) ? "style='display:block'" : "style='display:none'" ?>><a href="index.php?controller=araal&action=listadoTrabajador">Trabajador</a></div>
            </div>
        </div>
