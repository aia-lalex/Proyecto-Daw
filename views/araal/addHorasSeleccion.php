                        ...
                        <select name="trabajador" required>
                            ...
                            if (!empty($datos)) {
                                foreach ($datos['datos'] as $dato) : // los mostramos los datos
                                    if ($dato['nombre'] == $dF['valores']['trabajador']) {
                        ...
                        <select name="obra" required>
                            ...
                            if (!empty($obra)) {
                                foreach ($obra['datos'] as $datoss) : // los mostramos los datos
                                    if ($datoss['nombre'] == $dF['valores']['obra']) {
                                        echo '<option value="' . $datoss['nombre'] . '" selected>' . $datoss['nombre'] . '</option>';
                                    } else {
                                        echo '<option value="' . $datoss['nombre'] . '">' . $datoss['nombre'] . '</option>';
                                    }
                                endforeach;
                            }
                            ?>
