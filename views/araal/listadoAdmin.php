    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col">
                ...
                <h1 class="text-center">Menú del administrador</h1>
                <hr>
                <h1 class="text-center">Listados</h1></br>
            </div>
        </div>
        <div class="row align-items-start">
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoHorasAdmin"><button class="espacio"><i class="fa-solid fa-list-check fa-5x"></i></br>Listado de horas trabajadas firmadas</button> </a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoHorasProvisionalAdmin"><button class="espacio"><i class="fa-solid fa-list fa-5x"></i></br>Listado de horas trabajadas para firmar</button></a> </br>
            </div>

            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoPersonalAdmin"><button class="espacio"><i class="fa-solid fa-person fa-5x"></i></br>Listado trabajadores administrador</button></a> </br>
            </div>

        </div>
        <div class="row align-items-start">
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoPersonalOff"><button class="espacio"><i class="fa-solid fa-person-walking-luggage fa-5x"></i></br>Listado personal fuera</button></a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoUsuario"><button class="espacio"><i class="fa-solid fa-user fa-5x"></i></br>Listado usuarios de web</button></a> </br>
            </div>
            <div class="col">
            </div>
        </div>
                <hr>
        <h1 class="text-center">Materiales</h1></br>
        <div class="row align-items-start">
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoAlmacenHistorico"><button class="espacio"><i class="fa-solid fa-warehouse fa-5x"></i></br>Listado de almacen historico</button> </a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoAlmacenAdmin"><button class="espacio"><i class="fa-solid fa-warehouse fa-5x"></i></br>Listado de almacen administrador</button> </a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoMateriales"><button class="espacio"><i class="fa-solid fa-warehouse fa-5x"></i></br>Listado materiales obras</button></a> </br>
            </div>
        </div>
        <hr>
        <h1 class="text-center">Obras terminadas</h1></br>
        <div class="row align-items-start">
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoObraAdmin"><button class="espacio"><i class="fa-solid fa-house fa-5x"></i></br>Costes de obra en curso</button></a>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoObraTerminada"><button class="espacio"><i class="fa-solid fa-house-circle-check fa-5x"></i></br>Listado obras terminadas</button></a> </br>
            </div>
            <div class="col">
            </div>
        </div>
        ...
        <hr>
        <h1 class="text-center">Añadir</h1></br>
        <div class="row align-items-end">
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=addAlmacenAdmin"><button class="espacio"><i class="fa-solid fa-warehouse fa-5x"></i></br>Añadir materiales almacen administrador</button></a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=addPersonal"><button class="espacio"><i class="fa-solid fa-plus fa-5x"></i></br>Añadir nuevos trabajadores</button></a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=addObra"><button class="espacio"><i class="fa-solid fa-house-flag fa-5x"></i></br>Añadir nueva obra</button></a></br>
            </div>
        </div>
    </div>
