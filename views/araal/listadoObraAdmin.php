...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="text-center">Lista de obras en curso</h1>
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th>Coste horas empleadas y materiales</th>
                            <th>Direccion</th>
                            <th>Ciudad</th>
                            <th>Número</th>
                            <th>Localidad</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td> <?php echo $dato['horasTotal'] ?> </td>
                                ...
                                <td class="botones">
                                    <a href="index.php?controller=araal&action=detalleObra&id=<?php echo $dato['idObra'] ?>"><i class="fa-solid fa-circle-info"></i></a>

                                    <a class="btn-danger" href="index.php?controller=araal&action=deleteObra&id=<?php echo $dato['idObra'] ?>&nombreObra=<?php echo $dato['nombreObra'] ?>&horasTotal=<?php echo $dato['horasTotal'] ?>&coste=<?php echo  $dato['coste'] ?>" onclick="return confirm('¿Desesas terminar la obra?');"><i class="fa-solid fa-x"></i></a>
                                </td>
                            </tr>
                ...
                if (!isset($dato) or $dato == null) {
                    echo '<h4>No existe ninguna obra en curso</h4>';
                }
                ?>
