...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="text-center">Listado de almacen</h1>
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td> <?php echo $dato['minimo'] ?> </td>
                                <td> <?php echo $dato['precio'] ?> </td>
                                <td class="botones">
                                    <a class="btn-danger" href="index.php?controller=araal&action=deleteHoras&id=<?php echo $dato['id'] ?>" onclick="return confirm('¿Desesas borrar el registro?');"><i class="fa-solid fa-x"></i></a>
                                    <a class="btn" href="index.php?controller=araal&action=editAlmacenAdmin&id=<?php echo $dato['id'] ?>&nombreProducto=<?php echo $dato['nombreProducto'] ?>&descripcion=<?php echo $dato['descripcion'] ?>&stock=<?php echo $dato['stock'] ?>&minimo=<?php echo $dato['minimo'] ?>&precio=<?php echo $dato['precio'] ?>" onclick="return confirm('¿Desesas editar el registro?');"><i class="fa-solid fa-pen-to-square"></i></a>
                ...
                if (!isset($dato) or $dato == null) {
                    echo '<h4>No existen productos en el almacen</h4>';
                }
                ?>
