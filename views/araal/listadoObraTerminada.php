...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="text-center">Lista de obras terminadas</h1>
                ...
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($datos['datos'] as $dato) {
                            ...
                            $fechaFormateadaI = date("d/m/Y", strtotime($fechaini));
                            echo '
                <tr>
                    ...
                    <td>' . $dato['localidad'] . '</td> ';
                            ...
                            echo '<a href="index.php?controller=araal&action=imprimeObra&id=' . $dato['id'] . '"><i class="fa-solid fa-print" ></i></a> ';
                            echo '<a href="index.php?controller=araal&action=detalObra&id=' . $dato['id'] . '"><i class="fa-solid fa-circle-info" ></i></a> ';
                            echo '</td>';
                            echo '</tr>';
                        }
                        ?>
