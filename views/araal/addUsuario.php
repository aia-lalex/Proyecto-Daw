    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="panel">
                    <form action="index.php?controller=araal&action=addUsuario" method=post enctype="multipart/form-data"> <!--Formulario-->
                        ...
                        ?>
                        <label>pass:</label><br />
                        <input type="pass" name="pass" value="<?php echo $dF['valores']['pass']; ?>" /><br />
                        <?php
                    ...
                    <hr>
                    <a href="index.php?controller=araal&action=listadoUsuarios">Volver</a>
                </div>
            </div>
        </div>
    </div>
