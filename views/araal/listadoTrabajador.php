    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col">
                ...
                <h1 class="text-center">Menú del trabajador</h1>
                <hr>
        ...
        <div class="row align-items-start">
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoAlmacenUser"><button class="espacio"><i class="fa-solid fa-warehouse fa-5x"></i></br>Listado de almacen</button> </a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoMaterialesUser"><button class="espacio"><i class="fa-solid fa-plug fa-5x"></i></br>Listado de materiales usados en obra</button></a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=addMateriales"><button class="espacio"><i class="fa-solid fa-pen fa-5x"></i></br>Añadir materiales a obra</button></a>
            </div>
        </div>
        <div class="row align-items-center">
        <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=addAlmacen"><button class="espacio"><i class="fa-solid fa-lightbulb fa-5x"></i></br>Añadir materiales al almacen</button></a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoObraUser"><button class="espacio"><i class="fa-solid fa-person-digging fa-5x"></i></br>Listado de obra</button> </a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=addAlmacen"><button class="espacio"><i class="fa-solid fa-lightbulb fa-5x"></i></br>Añadir materiales al almacen</button></a> </br>
            </div>
        ...
        <hr>
        <h1 class="text-center">Horas</h1></br>
        <div class="row align-items-center">
        <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=addHoras"><button class="espacio"><i class="fa-solid fa-hourglass-start fa-5x"></i></br>Añadir horas a obra</button></a> </br>
            </div>
           
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoHorasUser"><button class="espacio"><i class="fa-solid fa-list fa-5x"></i></br>Listado de horas trabajadas sin firmar</button></a> </br>
            </div>
            <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoHorasFUser"><button class="espacio"><i class="fa-solid fa-list-check fa-5x"></i></br>Listado de horas trabajadas firmadas</button></a> </br>
            </div>
        ...
        <div class="col">
                <a class="espacio" href="index.php?controller=araal&action=listadoPersonalUser"><button class="espacio"><i class="fa-solid fa-person fa-5x"></i></br>Listado de personal</button> </a> </br>
            </div> 
            <div class="col">
            </div> 
            <div class="col">
