...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1 class="text-center">Lista de trabajadores despedidos</h1>
                <table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        foreach ($datos['datos'] as $dato) {
                            ...
                            $fechaOff = $dato['fechaoff'];
                            $fechaFormateadaOff = date("d/m/Y", strtotime($fechaOff));
                ...
                <tr>
                    ...
                    <td class="imagenConcierto">' . '<img src="http://' . $_SERVER['SERVER_NAME'] . '/araal' . $dato['url'] .  '" height="100"/>';

                                //  echo '<td class="botones">';
                                //   echo '<a href="index.php?controller=araal&action=delete&id='.$dato['id'].'&valor='.$dato['valor'].'&nombre='.$dato['nombre'].'&fechaincor='.$dato['fechaIncor'].'&url='.$dato['url'].'&puesto='.$dato['puesto'].'&fechaoff='.$dato['fechaoff'].'"><img src="./web/css/delete.png" alt="firma"></a> ';


                                //   echo '<td>' . $fechaFormateadaOff . '</td>'
                            ;
                            echo '</td>';
                            echo '</tr>';
                        }
                ...
                if (!isset($dato) or $dato == null) {
                    echo '<h4>No hay personal fuera</h4>';
                }
                ?>
