...
$dF['valores']['nombre'] = $nombreProducto;
$dF['valores']['descripcion'] = $descripcion;
$dF['valores']['stock'] = $stock;
$dF['valores']['precio'] = $precio;
$dF['valores']['minimo'] = $minimo;
$dF['valores']['id'] = $id;
?>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col">
                ...
                <h2 class="text-center">Editar materiales en almacen</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center">
                <div class="panel">
                    <form action="index.php?controller=araal&action=guardaAlmacenAdmin" method=post enctype="multipart/form-data"> <!--Formulario-->
                        ...
                        <input type="text" name="id" value="<?php echo $dF['valores']['id']; ?>" style='display:none' /><br />
                        ...
                        <input type="text" name="descripcion" value="<?php echo $dF['valores']['descripcion']; ?>" /><br />
                        <?php
                        if (isset($dF['errores']['descripcion']) && !empty($dF['errores']['descripcion'])) {
                            echo '<span class="rojo">' . $dF['errores']['descripcion'] . '</span><br/>';
                        }
                        ?>
                        <label>Stock:</label><br />
                        <input type="text" name="stock" value="<?php echo $dF['valores']['stock']; ?>" /><br />
                        <?php
                        if (isset($dF['errores']['stock']) && !empty($dF['errores']['stock'])) {
                            echo '<span class="rojo">' . $dF['errores']['stock'] . '</span><br/>';
                        }
                        ?>
                        <label>precio:</label><br />
                        <input type="text" name="precio" value="<?php echo $dF['valores']['precio']; ?>" /><br />
                        <?php
                        if (isset($dF['errores']['precio']) && !empty($dF['errores']['precio'])) {
                            echo '<span class="rojo">' . $dF['errores']['precio'] . '</span><br/>';
                        }
                        ?>
                        <label>minimo:</label><br />
                        <input type="text" name="minimo" value="<?php echo $dF['valores']['minimo']; ?>" /><br />
                        <?php
                        if (isset($dF['errores']['minimo']) && !empty($dF['errores']['minimo'])) {
                            echo '<span class="rojo">' . $dF['errores']['minimo'] . '</span><br/>';
                        }
                        ?>
                        <hr>
                    ...
                    <hr>
                    <a href="index.php?controller=araal&action=listadoAlmacen">Volver</a>
                </div>
            </div>
        </div>
    </div>
    <footer class="container-fluid py-5 mt-5">
        <div class="row">
            ...
            <div class="col-12 col-md-4 mt-4 mt-md-0">
                ...
                <div id=2 <?php echo isset($_SESSION['usu']) ? "style='display:block'" : "style='display:none'" ?>><a href="index.php?controller=araal&action=listadoTrabajador">Trabajador</a></div><a href="./views/araal/contacto.php">Contacto</a>
            </div>
        </div>
