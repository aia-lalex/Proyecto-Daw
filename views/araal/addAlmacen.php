    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="panel">
                    <form action="index.php?controller=araal&action=addAlmacen" method=post enctype="multipart/form-data"> <!--Formulario-->
                        ...
                        <select name="trabajador" required>
                            ...
                            if (!empty($usuarios)) {
                                foreach ($usuarios['datos'] as $datoss) : // los mostramos los datos
                                    if ($datoss['id'] == $dF['valores']['trabajador']) {
                                        echo '<option value="' . $datoss['id'] . '" selected>' . $datoss['nombre'] . '</option>';
                                    } else {
                                        echo '<option value="' . $datoss['id'] . '">' . $datoss['nombre'] . '</option>';
                                    }
                                endforeach;
                            }
                            ?>
                        ...
                        <select name="nombre" required>
                            ...
                            <?php
                            if (!empty($datos)) {
                                foreach ($datos['datos'] as $dato) : // los mostramos los datos
                                    if ($dato['id'] == $dF['valores']['nombre']) {
                                        echo '<option value="' . $dato['id'] . '" selected>' . $dato['nombreProducto'] . '</option>';
                                    } else {
                                        echo '<option value="' . $dato['id'] . '">' . $dato['nombreProducto'] . '</option>';
                                    }
                                endforeach;
                            }
                            ?>
                        ...
                        ?>
                        <label>Stock a introducir:</label><br />
                        <input type="number" name="stoc" value="<?php echo $dF['valores']['stoc']; ?>" /><br />
                        <?php
                        if (isset($dF['errores']['stoc']) && !empty($dF['errores']['stoc'])) {
                            echo '<span class="rojo">' . $dF['errores']['stoc'] . '</span><br/>';
                        }
                        ?>
                        <br />
                        <hr><button type="submit">Guardar</button>
                    </form>
                    <hr>
