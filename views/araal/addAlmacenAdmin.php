    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col">
                ...
                <h2 class="text-center">Insertar materiales en almacen</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center">
                <div class="panel">
                    <form action="index.php?controller=araal&action=addAlmacenAdmin" method=post enctype="multipart/form-data"> <!--Formulario-->
                        ...
                        <input type="number" name="stock" value="<?php echo $dF['valores']['stock']; ?>" /><br />
                        <?php
                        ...
                        <input type="number" name="precio" value="<?php echo $dF['valores']['precio']; ?>" /><br />
                        <?php
                        ...
                        <input type="number" name="minimo" value="<?php echo $dF['valores']['minimo']; ?>" /><br />
                        <?php
