                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php
                                echo '<td class="imagenConcierto">' . '<img src="http://' . $_SERVER['SERVER_NAME'] . '/araal' . $dato['url'] .  '" height="100"/>';
                                ?>
                                <td class="botones">
                                    <a class="btn-danger" href="index.php?controller=araal&action=delete&id=<?php echo $dato['id'] ?>&url= <?php echo $dato['url'] ?>&puesto= <?php echo $dato['idPuesto'] ?>&fechaincor= <?php echo $dato['fechaincor'] ?>&nombre=<?php echo $dato['nombre'] ?>&valor=<?php echo $dato['valor'] ?>&fechaoff=<?php echo  $dato['fechaoff'] ?>&dni=<?php echo  $dato['dni'] ?>" onclick="return confirm('¿Desesas aceptar el registro?');"><i class="fa-solid fa-x"></i></a>
                                </td>
                            </tr>
